...
var email = {
  ...
  sanityCheck: function (email, callback) {
  ...
  activationLink: function (email, token, headers, callback) {
    ...
    if (process.env.NODE_ENV == "production") {
      ...
      console.log(`http://localhost:1138/activate/${token}`);
      callback();
    }
  }
