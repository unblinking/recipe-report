...
class Token {
    constructor() {
        ...
        this.encodeToken = (userId, type, ttl) => {
            ...
            const encryptedPayload = this.cryptography.encrypt(stringified);
        ...
        this.decodeToken = (token) => {
            ...
            const decryptedPayload = this.cryptography.decrypt(decodedToken);
